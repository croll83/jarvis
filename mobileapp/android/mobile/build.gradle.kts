...
// Credenziali di firma lette da keystore.properties (gitignored). Se il file manca
// (es. build di debug o CI senza segreti) la release resta non firmata ma compila.
