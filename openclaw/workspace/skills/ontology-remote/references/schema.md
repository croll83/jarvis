...
relations:
  ...
  related_to:
    ...
    description: "Family, social, or professional relationship between two people. Use relation_type property to specify."
    properties:
      relation_type_enum: [spouse, child, parent, grandparent, grandchild, sibling, friend, colleague, acquaintance]
